...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is used to check each element of the selectSquaure array
    //to see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This variable retrieves the HTML element id that was clicked.
        let select = document.getElementById(squareNumber);
        //This condition checks eho's turn it is.
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the x.png is placed in HTML
            select.style.backgroundImage = 'url("images/HH.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'o', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/SS.png")';
        }
  ...
  //This function parses the selected Squares for win conditions.
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        let x1 = coordX1,
        //This line indicates where the start line of a lines y axis is.
            y1 = coordY1,
        ...
        function animateLineDrawing() {
            ...
            //This condition is similaar to the one above.
